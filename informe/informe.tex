...
\title[Wiretapping de paquetes ARP]{%
	Analizando redes locales usando Teor\'ia de la Informaci\'on y Wiretapping de paquetes ARP
}
...
\begin{abstract} 
Con el objetivo de comprender diversos aspectos de una red local, nos planteamos analizar sus paquetes ARP usando herramientas de la teor\'ia de la informaci\'on.
